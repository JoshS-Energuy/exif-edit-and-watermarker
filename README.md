...
This is the `exif-watermarker` branch: a standalone single-tool build.
The `master` branch has this tool plus a ZIP-to-PDF tool behind a
tool-picker pane; the `zip-to-pdf` branch has that other tool standalone.
